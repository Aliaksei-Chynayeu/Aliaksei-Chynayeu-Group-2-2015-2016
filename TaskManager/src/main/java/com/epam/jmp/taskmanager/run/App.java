...
import com.epam.jmp.taskmanager.util.thread.FileReaderThread;
import com.epam.jmp.taskmanager.util.thread.FileWriterThread;
...
public class App {
	...
	public static void main(String[] args) throws Exception, RuntimeException {
		...
		LOG.info("Specify the path to file");
